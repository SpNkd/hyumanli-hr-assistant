...
1. На Overview нажмите **Запустить коммуникацию**.
2. Выберите Дмитрия Ковалёва, цель eNPS и поддерживающий тон.
3. Запустите план: появятся два письма и три контрольные точки.
4. Откройте Prompt preview, затем Timeline и покажите сдвиг follow-up с выходного.
5. Нажмите **+7д**, чтобы показать автоматический follow-up.
6. В другой коммуникации нажмите **Симулировать ответ** — будущие события архивируются автоматически.

Полный сценарий и fallback находятся в [`docs/DEMO.md`](./docs/DEMO.md).
...
Документация: [`PRODUCT.md`](./docs/PRODUCT.md), [`ARCHITECTURE.md`](./docs/ARCHITECTURE.md), [`DATA_MODEL.md`](./docs/DATA_MODEL.md), [`DECISIONS.md`](./docs/DECISIONS.md), [`PITCH.md`](./docs/PITCH.md).
