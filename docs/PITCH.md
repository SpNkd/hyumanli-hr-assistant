...
В демо мы запускаем eNPS для Дмитрия Ковалёва одной кнопкой, показываем два письма и timeline, ускоряем время, видим follow-up и затем симулируем ответ. Все будущие события архивируются мгновенно.
